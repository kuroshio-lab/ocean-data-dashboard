...
class TemperatureObservationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'location', 'location_name', 'source', 'source_name',
            'timestamp', 'temperature_celsius', 'quality_flag', 'created_at'
        ]
        read_only_fields = ['created_at']
...
class SalinityObservationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'location', 'location_name', 'source', 'source_name',
            'timestamp', 'salinity_psu', 'quality_flag', 'created_at'
        ]
        read_only_fields = ['created_at']
...
class CurrentObservationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'location', 'location_name', 'source', 'source_name',
            'timestamp', 'speed_ms', 'direction_degrees', 'u_component',
            'v_component', 'quality_flag', 'created_at'
        ]
        read_only_fields = ['created_at']
...
class IngestionLogSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'completed_at', 'duration_seconds', 'records_fetched',
            'records_inserted', 'error_message', 'task_id'
        ]
